...
- bugrap-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- bugrap-ui: main application module, development time
- bugrap-production: module that produces a production mode WAR for deployment
